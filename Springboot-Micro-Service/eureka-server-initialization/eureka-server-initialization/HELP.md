...
* The original package name 'com.Ecommerce.eureka-server-initialization' is invalid and this project uses 'com.Ecommerce.eureka_server_initialization' instead.
